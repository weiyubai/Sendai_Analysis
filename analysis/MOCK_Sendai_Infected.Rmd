...
Mock_Infect <- countReads(samplenames = samplenames1 ,
                          gtf = gtf,
                          bamFolder = "/media/bai/Data/data_zhang/SEQ/result/sendai/MeRIP/sort",
...
write.table(dplyr::filter(Mock_peaks,enrichmentScore>1.5),file = "/home/bai/Sendai_Analysis/data/Mocksamplenames1_peaks.xls", sep = "\t",col.names = T,row.names = F,quote = F)
DT::datatable(dplyr::filter(Mock_peaks,enrichmentScore>1.5), options = list(scrollX = TRUE, keys = TRUE, pageLength = 10),rownames = F)

 
```
Plot coverage of Mock samplenames mRNA(Mocke)
...
write.table(dplyr::filter(sendai_peaks,enrichmentScore>1.5),file = "/home/bai/Sendai_Analysis/data/sendaisamplenames2_peaks.xls", sep = "\t",col.names = T,row.names = F,quote = F)
DT::datatable(dplyr::filter(sendai_peaks,enrichmentScore>1.5), options = list(scrollX = TRUE, keys = TRUE, pageLength = 10),rownames = F)
```
